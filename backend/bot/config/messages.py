...
Проведите оплату по кнопке «Оплатить»\
"""
...
PAYMENT_ALREADY_DONE: str = """\
✅ Платёж уже произведён! Тариф активен
"""
...
RECCURENT_PAYMENT_INIT: str = """\
🕘 Платёж инициирован, ожидайте ответа от бота!
"""

RECCURENT_PAYMENT_DONE: str = """\
✅ Конфиг {config_name} автоматически продлён!
Срок действия конфига: {expiring_at}\
"""

RECCURENT_PAYMENT_FAILED: str = """\
⚠️ Не удалось оплатить подписку на конфиг {config_name}!
Доступ к конфигу приостановлен! Чтобы восстановить доступ к ВПН, \
пожалуйста, разрешите автоплатежи в приложении своего банка!

После, нажмите на кнопку ниже и средства автоматически спишутся с Вашего счёта
"""
...
<b>После оплаты нажмите на кнопку «✅ Готово»</b>\
"""
...
SUB_RESTORED: str = """\
Подписка на конфиг {config_name} включена!\
"""
